...
### Standard
 ...
 | Not available
 | 5,000 prompts per month (free, shared across Gemini 3), then $14 / 1,000 search queries for text and image-based grounding.
 |
...
$2.00 (audio)
 ...
 | Grounding with Google Search
 | Not available
 | 5,000 prompts per month (free, limit shared with Flash), then $14 / 1,000 search queries for text and image-based grounding.
 |
 ...
 **Input tokens** when the model uses them as part of its
 ...
 | Not available
 | Charged as regular tokens per model pricing (e.g., standard [Gemini 3.5 Flash](#gemini-3.5-flash) pricing). See the [Gemini 2.5 Computer Use Preview](#gemini-2.5-computer-use-preview-10-2025) pricing table for legacy model rates.
 |
