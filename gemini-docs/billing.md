...
| **Tier 1**
| [Set up and link an active billing account](#setup-billing)
| $250
|
...
- Go to the AI Studio [API keys](https://aistudio.google.com/api-keys) page,
...
- Find the Free Tier project you want to upgrade to the Paid Tier, and click
**Set up billing** under the *Billing Tier* column.
- If you've never set up a Google billing account before:
...
- If you have set up Google billing accounts in the past:
...
- After prepaying or selecting Postpay, your account setup is complete.
...
- Go to the [AI Studio Billing](https://aistudio.google.com/billing) page.
- Click **Manage auto-reload**.
- Expand the **Monthly Limit** section and enter the maximum monthly limit for auto-reloads.
- Click **Save**.
...
- In the Google Cloud console, view your [Cloud Billing account Reports](https://console.cloud.google.com/billing/reports) page.
...
- The report defaults to "Group by Service" in the "Current month". You will
see **Gemini API** in the **Service** column and total spend in the **Usage
cost** column of the table.
- To see granular costs limited to Gemini API usage, set the **Group by**
filter to group by **SKU**, and the **Services** filter to **Gemini API**.
- Adjust the **Time range by usage date** filter to your desired range to
