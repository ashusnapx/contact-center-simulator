...
- **Add a secret**: Go to the **Settings** menu in Google AI Studio and look
for the Secrets section.
- **Store your key**: Add your API keys or secret tokens here.
- **Access in code**: The Agent can write server-side code that accesses these
...
- Wires up the necessary Google API for your app.
- Generates the server-side code to call the API.
- Adds a secure "Sign in with Google" flow so end users of your app can
...
| Google Calendar
| Read, create, and manage events and calendars
|

| Google Chat
| Read and interact with conversations and group spaces
|

| Google Docs
| Create, read, update, and format documents
|

| Google Drive
| Organize, search, and manage files and folders
|

| Google Forms
| Create surveys, update questions, and retrieve responses
|

| Gmail
| Read, send, and manage email content
|

| Google Keep
| Manage notes, lists, and attachments
|
...
- Open your app in Google AI Studio Build mode in multiple tabs. When
...
- Share the app with others using the **Share** menu at the top right.
