...
Quickstart
 ...
 ](/gemini-api/docs/managed-agents-quickstart)
 [
...
Agents in AI Studio
 ...
 ](/gemini-api/docs/aistudio-agents)
...
| Ubuntu-based environment with Python 3.12 and Node.js 22. For more information on the environment's base image, see [Pre-installed software](/gemini-api/docs/agent-environment#pre-installed-software).
|
